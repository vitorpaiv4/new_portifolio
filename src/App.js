  ...
  return (
    <div className="mx-auto bg-slate-50 text-black min-h-screen py-8">
      <nav className="flex justify-between items-center pb-5  px-5">
        ...
        <div className="hidden md:flex items-center gap-5 lg:flex ">
          ...
          <button onClick={() => scrollToSection('hobbies')} className='flex gap-2 hover:text-gray-300'><CommandLineIcon className='h-5' />Hobbies</button>
          <button onClick={() => scrollToSection('formacion')} className='flex gap-2 hover:text-gray-300'><AcademicCapIcon className='h-5' />Formação</button>
        ...
        <button onClick={() => scrollToSection('home')} className='flex gap-2 hover:text-gray-300'><Bars3Icon className='h-5' /></button>
        </div>
      </nav>
